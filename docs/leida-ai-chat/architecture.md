# Leida AI Chat Architecture

## System Overview

Leida AI Chat uses Eve as the agent runtime layer and Vercel primitives for model access, durable execution, and isolated compute.
