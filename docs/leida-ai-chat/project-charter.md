# Leida AI Chat Project Charter

## Purpose

Leida AI Chat is a production-style example agent application designed to demonstrate how to build and deploy a durable, multi-tool conversational assistant on Vercel using Eve.

The app must feel like a real product with clear scope, ownership, operations, and deployment standards.

## Product Narrative

Leida AI Chat is a domain-aware assistant that helps users ask questions, retrieve trusted project knowledge, and execute approved actions through a clean chat interface.
